export class Residents {
    ...
    constructor(
        ...
        this._id = id;
        this._iedzivotajsId=iedzivotajsId;
        this._vards = vards;
    ...
    get iedzivotajsId(): number {
        return this._iedzivotajsId;
    }
    set iedzivotajsId(value: number) {
        this._iedzivotajsId = value;
    }
